\chapter{Introduction to Linear Systems \& Linear Algebra Foundations}
...
\end{align}
Expressing these relations in matrix-vector form gives the **Controllability Canonical Form**:
\begin{equation}
