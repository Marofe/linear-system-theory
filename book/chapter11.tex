...
To illustrate how the switching behavior itself can induce instability even if all individual modes are stable, consider the numerical experiment in Figures \ref{fig:mjls_no_switching} and \ref{fig:mjls_switching_instability} (collectively shown in Figure \ref{fig:mjls_instability_demo}).
