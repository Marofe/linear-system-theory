...
Stability is the most critical requirement of any dynamical system. In control engineering, a system is stable if its state remains close to an equilibrium point under small perturbations, as conceptually shown in Figure \ref{fig:stability}. Symmetrically, it is unstable if the states diverge under tiny disturbances.

\begin{figure}[H]
    \centering
    \includegraphics[width=6cm]{stability.png}
    \caption{Conceptual potential well representation of Lyapunov stability.}
    \label{fig:stability}
\end{figure}
...
\end{equation}
\end{mydefinition}
This definition ensures that states starting close to the origin remain bounded within an $\epsilon$-ball for all future time, as geometrically illustrated in Figure \ref{fig:stability_lyap_balls}.

\begin{figure}[H]
    \centering
    \includegraphics[width=6.5cm]{stability_bibo.png}
    \caption{Geometric definition of Lyapunov stability, showing that trajectories starting inside a $\delta$-ball remain inside an $\epsilon$-ball for all $t \ge 0$.}
    \label{fig:stability_lyap_balls}
\end{figure}
...
\end{enumerate}
\end{mydefinition}
This asymptotic convergence behavior is illustrated geometrically in Figure \ref{fig:stability_asymptotic_lyap}, and its time-domain state trajectories are plotted in Figure \ref{fig:stability_asymptotic}.

\begin{figure}[H]
    \centering
    \includegraphics[width=6.5cm]{stability_assymptotic_lyap.png}
    \caption{Geometric definition of asymptotic stability, where trajectories not only remain bounded but eventually converge to the origin.}
    \label{fig:stability_asymptotic_lyap}
\end{figure}


\begin{figure}[H]
    \centering
    \includegraphics[width=6cm]{stability_asymptotic.png}
    \caption{State trajectories of an asymptotically stable system converging to the origin.}
    \label{fig:stability_asymptotic}
\end{figure}
...
An exponentially stable response bounded by a decaying exponential envelope is shown in Figure \ref{fig:stability_exponential}.

\begin{figure}[H]
    \centering
    \includegraphics[width=7cm]{stability_exponential.png}
    \caption{State trajectory of an exponentially stable system bounded by a decaying exponential envelope.}
    \label{fig:stability_exponential}
\end{figure}
...
The stable complex plane regions for continuous-time and discrete-time systems are compared in Figure \ref{fig:estabilidade_discreta}.

\begin{figure}[H]
    \centering
    \includegraphics[width=10cm]{estabilidade_discreta.png}
    \caption{Comparison of stability regions: LHP in the $s$-plane for continuous-time systems vs. inside the unit circle in the $z$-plane for discrete-time systems.}
    \label{fig:estabilidade_discreta}
\end{figure}
...
\end{equation}
This convex matrix polytope is geometrically represented in Figure \ref{fig:politopo}.

\begin{figure}[H]
    \centering
    \includegraphics[width=6cm]{politopo.png}
    \caption{Polytopic uncertainty region where the dynamic matrix $A(\alpha)$ is a convex combination of vertex matrices $A_i$.}
    \label{fig:politopo}
\end{figure}
...
The parameter variations over time are illustrated within the matrix polytope in Figure \ref{fig:politopo_time_varying}.

\begin{figure}[H]
    \centering
    \includegraphics[width=6.5cm]{politopo_time_varying.png}
    \caption{Time-varying polytopic system trajectory, illustrating the dynamic variation of the system matrix $A(\alpha(t))$ within the convex polytope.}
    \label{fig:politopo_time_varying}
\end{figure}
