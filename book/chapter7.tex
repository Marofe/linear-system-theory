...
We recognize the integrals inside the parentheses as the **Observability Gramian** $P_o$ and **Controllability Gramian** $P_c$, which satisfy the Lyapunov equations:
\begin{align}
