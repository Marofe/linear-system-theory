...
The peak frequency amplification defining the H-infinity norm is shown in Figure \ref{fig:hinf_norm} for continuous systems.
...
The discrete-time H-infinity norm peak gain is shown in Figure \ref{fig:hinf_norm_discrete}.
